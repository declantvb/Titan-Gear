...
public class Inventory : MonoBehaviour
{
	...
	public delegate void SlotItemDelegate(PartSlot slot, Item item);

	public static event ItemDelegate ItemConsumed;

	public static event SlotItemDelegate ItemEquip;

	public static event SlotItemDelegate UnEquipItem;
	...
	public void EquiptItem(PartSlot slot, Item item)
	{
		if (ItemEquip != null)
			ItemEquip(slot, item);
	}

	public void UnEquipItem1(PartSlot slot, Item item)
	{
		if (UnEquipItem != null)
